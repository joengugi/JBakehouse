...
export default function AdminLogin({ onClose }: AdminLoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      // Check the browser console after clicking Sign In.
      ...
      if (result.ok) {
        ...
        // corresponds to /admin/dashboard
        ...
        >
          ...
          >
            <svg width="18" height="18" viewBox="0 0 18 18">
              ...
              <path
                fill="#34A853"
                d="M9 18c2.43 0 4.467-.806 5.956-2.184l-2.908-2.258c-.806.54-1.837.86-3.048.86-2.344 0-4.328-1.584-5.036-3.711H.957v2.332C2.438 15.983 0 9s.348 2.827.957 4.042l3.007-2.335z"
              />
              <path
                fill="#FBBC05"
                d="M3.964 10.707c-.18-.54-.282-1.117-.282-1.707 0-.593.102-1.17.282-1.709V4.958H.957C.347 6.173 0 7.548.957 13.042l3.007-2.335z"
              />
              <path
                fill="#EA4335"
